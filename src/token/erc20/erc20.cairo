...
mod ERC20 {
    ...
    #[external(v0)]
    impl ImplERC20External of IERC20<ContractState> {
        ...
        fn transfer_from(
            ref self: ContractState, sender: ContractAddress, recipient: ContractAddress, amount: u256) -> bool {
    ...
    #[generate_trait]
    impl ImplERC20Internal of IERC20Internal {
